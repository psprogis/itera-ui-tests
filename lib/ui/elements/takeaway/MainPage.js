...
class MainPage {
    ...
    async open() {
        ...
        // find out chrome setting to disable cookies and remove this workaround
        const acceptAllCookiesButton = $('button[aria-label]');

        await waitElementVisible({ element: acceptAllCookiesButton });
